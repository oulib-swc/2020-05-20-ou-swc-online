...
instructor: ["TBD", "Logan Cox (shell)", Mark Laufersweiler (Git)] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Theo Acker", "Claire Curry","Toni Hoberecht", "Tyler Pearson","Mark Laufersweiler"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
